              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('requireBiometric', checked)}
                  />
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('cloudSync', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('compressionEnabled', checked)}
                  />
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('desktopNotifications', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('emailAlerts', checked)}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  >
                    ...
                    <option value="system" className="bg-slate-800">System Preference</option>
                  </select>
                  <p className="text-gray-400 text-xs mt-1">
                    Current: {actualTheme === 'dark' ? 'Dark Mode' : 'Light Mode'}
                  </p>
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('hardwareAcceleration', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('preloadFiles', checked)}
                  />
                </div>
              ...
              <CardContent className="grid md:grid-cols-3 gap-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateSetting('telemetryEnabled', checked)}
                  />
                </div>
              </CardContent>
            </Card>
